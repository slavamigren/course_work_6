...
from mailing.views import MailinListView, MessageListView, MessageCreateView, MessageDeleteView, \
    ...
    change_mailing_is_active, main_page
...
urlpatterns = [
    path('mailing_list', cache_page(60)(MailinListView.as_view()), name='mailing_list'),
    ...
    path('change_mailing_is_active/<int:pk>/<act>/', change_mailing_is_active, name='change_mailing_is_active'),
    ...
    path('loglist_list/', cache_page(60)(LogListListView.as_view()), name='loglist_list'),
